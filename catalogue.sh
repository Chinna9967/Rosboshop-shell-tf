...
cp /home/centos/Rosboshop-shell-tf/catalogue.service /etc/systemd/system/catalogue.service &>>$LOGFILE
...
mongo --host mongodb.kpdigital.online < /app/schema/catalogue.js &>>$LOGFILE
